...
public class ColorSensorTesting extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            if (hsvValues[1] < 0.210) {
                telemetry.addData("Red", hsvValues[1]);
            } else if (hsvValues[1] > 0.450 && hsvValues[0] > 130) {
                telemetry.addData("Green", hsvValues[1]);
            } else {
                telemetry.addData("Black", hsvValues[1]);
            }
